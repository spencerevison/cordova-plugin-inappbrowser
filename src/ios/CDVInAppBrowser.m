...
- (void)createViews
{
    ...
    self.toolbar.barTintColor = [UIColor colorWithRed:55.0 / 255.0 green:66.0 / 255.0 blue:93.0 / 255.0 alpha:1];
...
- (void) viewDidLoad {
    ...
    // bgToolbar.barTintColor = [UIColor colorWithRed:55.0 / 255.0 green:66.0 / 255.0 blue:93.0 / 255.0 alpha:1];
